...
vector<int> sorting_by_cost_function(Graph &g,vector<int> list_of_nodes_on_path){
    ...
    ofstream myfile;
    myfile.open("slackfile_slew_round_mod_14_09_06.txt",ios::out|ios::app);
...
//               
    ...
    ofstream myfile;
    myfile.open("replaced_gates_slew_round_mod_14_09_06.txt",ios::out|ios::app);
