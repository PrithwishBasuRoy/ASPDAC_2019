...
// slew calculation
    ...
    // vector<double> cell_rise_fall_index_hvt{0.00300,0.0045552,0.012331,0.027386,0.060822,0.135080,0.300000};
  ...
  //          slew_calculation(lvt_index_1,index_2,lvt_risetransitionmap,lvt_falltransitionmap,1, templevel,num1,g);
            ...
            slew_lvt_file.open("lvt_slew_file_cp_14_09_3.txt");
    ...
    if(pos !=string::npos){
        filename.replace(pos,4,".rise_cp_14_09_3_"+s_pi_r+"_"+s_pi_f);
    }
        ...
        slew_hvt_file.open("hvt_slew_file_cp_14_09_3.txt");
        cout<<"======= Following are the list of Slews for different Node============="<<endl;
        for(int i=0;i<size;i++)
        {
            //if(i==26149 || i==2789|| i==8616|| i==8602|| i==132791|| i==97948|| i==97947|| i==97945|| i==97944|| i==9663 || i==9662 || i==163436 )
