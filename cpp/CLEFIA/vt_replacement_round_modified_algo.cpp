...
vector<int> sorting_by_cost_function(Graph &g,vector<int> list_of_nodes_on_path){
    ...
    ofstream myfile;
    myfile.open("slackfile_slew_round_mod_13_09_01.txt",ios::out|ios::app);
            ...
            if(loadCapacitance == 0){
                if(number_of_fanouts == 1)
                    g[i].capacitance= 0.0027;
                     ...
                     g[i].capacitance= initial_net_capacitance_less_fanout+(number_of_fanouts - 1)*0.003;
                    //g[i].capacitance= initial_net_capacitance_less_fanout+(number_of_fanouts - 1)*0.004;
                
                else        
                    g[i].capacitance=initial_net_capacitance+(rf-1)*0.0015+9*0.003;
                ...
                if(number_of_fanouts == 1)
                    ...
                    g[i].capacitance=loadCapacitance+initial_net_capacitance+(rf-1)*0.0015+9*0.003;
...
int main(int argc,char *argv[])
{
    ...
    int num;
    if(argc!=35)//rvt leakage removed 
...
//            string choice=argv[6]; 
           ...
           //double gate_parameter;
            ...
            string input_delay_temp=argv[34];
            double temp_input_delay = ::atof(input_delay_temp.c_str());
            int tempnode;
        ...
        tempvect=required_time(temp_input_delay,maxlevel,vertex_count,g,list_of_nodes_on_path);
...
//              //The markednode stores the ith node from tempvect.
                ...
                temp_slew[1]=g[markednode].pred_slew_r_f[0];
...
//               
    ...
    ofstream myfile;
    myfile.open("replaced_gates_slew_round_mod_13_09_01.txt",ios::out|ios::app);
