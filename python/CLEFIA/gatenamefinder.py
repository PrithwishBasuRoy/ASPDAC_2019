...
f=open("replaced_gates_slew_round_mod_13_09_01.txt","r")
fn=open("list_of_replaced_gates_slew_round_mod_13_09_01.txt","w")
all_gates_temp=[]
for line in f:
...
for i in list_of_nodes:
	...
	cellname_for_current_node= fixed_nodes_cell_name+i-930
...
verilog_r= open("CLEFIA_synthesized.v","r")
verilog_w= open("CLEFIA_altered_13_09_01.v","w")
