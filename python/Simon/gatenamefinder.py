...
f=open("replaced_gates_slew_round_mod_09_09_03.txt","r")
fn=open("list_of_replaced_gates_slew_round_mod_09_09_03.txt","w")
all_gates_temp=[]
for line in f:
...
fixed_node= 348
fixed_nodes_cell_name=616 


for i in list_of_nodes:

	cellname_for_current_node= fixed_nodes_cell_name+i-348
	# if (cellname_for_current_node >= 18049) :
...
verilog_r= open("SIMON_enc_synthesized.v","r")
verilog_w= open("SIMON_enc_altered_09_09_03.v","w")
