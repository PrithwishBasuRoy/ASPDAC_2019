...
f=open("replaced_gates_slew_round_mod_14_09_06.txt","r")
fn=open("list_of_replaced_gates_slew_round_mod_14_09_06.txt","w")
all_gates_temp=[]
for line in f:
...
fixed_node= 790
fixed_nodes_cell_name=8014


for i in list_of_nodes:

	cellname_for_current_node= fixed_nodes_cell_name+i-790
	if (cellname_for_current_node >= 16620) :
...
verilog_r= open("Camellia_synthesized.v","r")
verilog_w= open("Camellia_altered_14_09_06.v","w")
